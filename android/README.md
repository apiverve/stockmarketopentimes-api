# Stock Market Open Times Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:stockmarketopentimes-api:1.1.13'
}
```
...
```java
import com.apiverve.stockmarketopentimes.StockMarketOpenTimesAPIClient;
import com.apiverve.stockmarketopentimes.APIResponse;
import com.apiverve.stockmarketopentimes.APIException;

// Initialize the client
StockMarketOpenTimesAPIClient client = new StockMarketOpenTimesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("exchange", "NYSE");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/stockmarketopentimes](https://docs.apiverve.com/ref/stockmarketopentimes)
...
- **Documentation:** [https://docs.apiverve.com/ref/stockmarketopentimes](https://docs.apiverve.com/ref/stockmarketopentimes)
- **Issues:** [GitHub Issues](https://github.com/apiverve/stockmarketopentimes-api/issues)
