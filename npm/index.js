...
class stockmarketopentimesWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/stockmarketopentimes');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/stockmarketopentimes';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"exchange":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/stockmarketopentimes`);
        }
    }
...
module.exports = stockmarketopentimesWrapper;
