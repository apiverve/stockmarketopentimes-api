...
namespace APIVerve.API.StockMarketOpenTimes
{
    ...
    /// <summary>
    /// Client for the StockMarketOpenTimes API
    /// </summary>
...
#endif
    {
        ...
        {
            { "exchange", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        private void ValidateParams(StockMarketOpenTimesQueryOptions options)
        {
