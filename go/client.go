// Package stockmarketopentimes provides a Go client for the Stock Market Open Times API.
//
// For more information, visit: https://apiverve.com/marketplace/stockmarketopentimes?utm_source=go&utm_medium=readme
package stockmarketopentimes
...
const (
	baseURL        = "https://api.apiverve.com/v1/stockmarketopentimes"
	defaultTimeout = 30 * time.Second
)

// Client is the Stock Market Open Times API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Stock Market Open Times API client.
...
// Execute makes a request to the Stock Market Open Times API with typed parameters.
//
...
//   - exchange (required): string - The stock exchange code
